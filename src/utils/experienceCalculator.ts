// Dynamic Experience Calculator with TypeScript
...
interface ExperienceBreakdown extends ExperienceEntry {
  duration: string;
 ...
 * Examples: "15 Months", "1+ Years", "2+ Years"
 */
 ...
 */
export const getCurrentExperience = (): string => {
 ...
 */
export const getExperienceBreakdown = (): ExperienceBreakdown[] => {
  const currentDate = new Date();
